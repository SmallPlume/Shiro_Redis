...
public class Upload {
	 ...
	 * @throws IOException
	 */
	public static void upload(HttpServletRequest request,Plupload plupload, File dir, FileInfo fileInfo)
			throws IllegalStateException, IOException {
		// 生成唯一的文件名
		String filename = plupload.getName();
		System.out.println("自动生产的名称==============" + filename);
		System.out.println("文件原名==============" + plupload.getName());
		upload(request,plupload, dir, filename, fileInfo);
	}
	 ...
	 * @throws IOException
	 */
	public static void upload(HttpServletRequest request,Plupload plupload, File dir, String filename,
